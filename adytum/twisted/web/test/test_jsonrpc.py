...
from adytum.twisted.jsonrpc import JSONRPC, addIntrospection
...
class Test(JSONRPC):
    ...
    def jsonrpc_fault(self):
        return jsonrpc.Fault(12, "hello")

    def jsonrpc_deferFault(self):
        return defer.fail(jsonrpc.Fault(17, "hi"))
    ...
    def _getFunction(self, functionPath):
        ...
        except jsonrpc.NoSuchFunction:
            if functionPath.startswith("SESSION"):
                raise jsonrpc.Fault(self.SESSION_EXPIRED, "Session non-existant/expired.")
            else:
                raise
...
class JSONRPCTestCase(unittest.TestCase):
    ...
    def testErrors(self):
        ...
        for code, methodName in [(666, "fail"), (666, "deferFail"),
            ...
            d = self.assertFailure(d, jsonrpc.Fault)
...
class JSONRPCClientErrorHandling(unittest.TestCase):
    ...
    def testErroneousResponse(self):
        ...
        ##return self.assertEquals(proxy.callRemote("someMethod"), 'Yo mamma')
        #d = proxy.callRemote("someMethod")
        #d.addCallback(self.assertEquals, 'Yo mamma')
        #return d
